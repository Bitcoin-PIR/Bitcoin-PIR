...
echo "  4. After reboot, fetch the candidate MEASUREMENT (do not publish it yet):"
echo "       bpir-admin attest wss://weikeng2.bitcoinpir.org"
echo "  5. Record the candidate alongside this UKI's sha256:"
echo "       UKI sha256:   $UKI_SHA"
echo "       Binary sha256: $BIN_HASH"
...
echo "       bpir-admin attest wss://weikeng2.bitcoinpir.org \\"
echo "           --expect-measurement <candidate MEASUREMENT> \\"
echo "           --expect-binary $BIN_HASH \\"
echo "           --expect-ark-fingerprint 1f084161a44bb6d93778a904877d4819cafa5d05ef4193b2ded9dd9c73dd3f6a"
echo "     Only publish the MEASUREMENT after this same-response verification passes."
