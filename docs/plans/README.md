...
| `PLAN_MULTI_QUERY_SIMULATOR_TEST.md` | Shipped. Multi-query simulator-property tests are covered by the verification overview and `crates/sdk/client/tests/leakage_integration_test.rs`. |
...
| `PLAN_ANONYMOUS_RATE_LIMIT.md` | Superseded by the architecture index `RATELIMIT_INTEGRATION.md`. |
