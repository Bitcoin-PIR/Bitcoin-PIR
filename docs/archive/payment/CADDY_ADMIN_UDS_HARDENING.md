# Existing Caddy admin Unix-socket hardening (archived)
...
[`bhtm-caddy-admin-uds-v1.plan.json.example`](../../payment/render-plan-skeletons/bhtm-caddy-admin-uds-v1.plan.json.example)
...
[`bhtm-caddy-admin-uds-v1.site-inventory.json.example`](../../payment/render-plan-skeletons/bhtm-caddy-admin-uds-v1.site-inventory.json.example),
