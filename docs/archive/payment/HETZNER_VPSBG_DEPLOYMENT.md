# Hetzner and VPSBG Payment V1 deployment preparation (archived)
...
[render-plan-skeletons/](../../payment/render-plan-skeletons/). A skeleton remains inert
...
2. Complete the selected
   [render-plan skeleton](../../payment/render-plan-skeletons/) using only values inventoried
