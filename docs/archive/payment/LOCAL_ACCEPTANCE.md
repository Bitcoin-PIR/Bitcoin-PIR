# Payment v1 local acceptance (archived)
...
from [render-plan-skeletons/](../../payment/render-plan-skeletons/). Those files do not turn
...
`docs/archive/payment/TEST_PLAN.md`. Together with the dedicated direct-receipt tests
