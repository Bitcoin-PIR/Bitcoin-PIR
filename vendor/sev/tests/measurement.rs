...
mod snp_tests {
    ...
    // Independently generated by virtee/sev-snp-measure with:
    // --mode snp --vcpus 2 --vcpu-sig 0x00B10F10 --vmm-type QEMU
    // --ovmf tests/measurement/ovmf_AmdSev_suffix.bin --kernel /dev/null
    // --guest-features 0x1
    #[test]
    fn test_snp_turin_9745_exact_cpuid_python_vector() {
        ...
        assert_eq!(CpuType::EpycTurin9745.sig(), 0x00B10F10);
    }
