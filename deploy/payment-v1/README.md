...
The host-wide change is not delegated to an edge or Caddy executor. It requires
the separately digest-approved, fail-closed transaction and explicit lost-core-
diagnostics acknowledgement in
