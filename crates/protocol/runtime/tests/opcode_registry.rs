...
fn request_opcode_registry_has_no_collisions() {
    assert_unique(&[
        ...
        // Retired with the ARC / Cashu verifiers (2026-09). Never reassign.
        ...
        ("CREDIT_PRESENT", REQ_CREDIT_PRESENT),
        ...
        ("PIR2_SEALED_RECEIPT_GET", REQ_PIR2_SEALED_RECEIPT_GET),
...
fn response_opcode_registry_has_no_collisions() {
    assert_unique(&[
        ...
        ("PIR2_SEALED_RECEIPT", RESP_PIR2_SEALED_RECEIPT),
