//! End-to-end HTTP test for the Cashu BDHKE mint: spawn `payment-issuer`, blind a
...
/// and the payment-issuer's WASM binding byte-for-byte).
...
#[test]
fn payment_issuer_cashu_mint_unblind_verify_over_http() {
