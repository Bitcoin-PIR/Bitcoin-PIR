...
// M=16 chunk-pad helper — dead in every build since Phase 3 / WS-A:
// OnionPIR dropped M-padding too (PLAN_MERKLE_CODING.md step 3d), so this
// lost its last caller. Kept compiling, unconditionally `dead_code`, until
// Phase 4 deletes it outright.
#[allow(dead_code)]
...
/// argument.
// M=16 chunk-pad helper — dead in every build since Phase 3 / WS-A (see
