...
\hline
Index (Level 1) & 13 B & 75 & 2-hash, bs=3 & 2 & $2^{20}$ \\
Chunks (Level 2) & 44 B & 80 & 2-hash, bs=3 & 2 & $2^{21}$ \\
\hline
\end{tabular}
\caption{Batch PIR parameters. Each level uses $K$ parallel PIR queries over cuckoo hash tables. Each DPF query retrieves one cuckoo bin: 3 slots $\times$ 13 B = 39 B for the index level, and 3 slots $\times$ 44 B = 132 B for the chunk level.}
\label{tab:databases}
\end{table}
