...
fn parse_args() -> CliArgs {
    ...
    CliArgs { port, data_dir, role, warmup, config_path, checkpoints, deltas, admin_pubkey_hex, disable_onion, vcek_dir, pool_size, pool_dir, require_arc, require_cashu, cashu_keysets, serve_hints, serve_queries, onion_index_group_range, onion_chunk_group_range, identity_key_path, identity_cert_path, identity_server_id }
}
